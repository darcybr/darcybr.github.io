...
/** @type {string} */
const CACHE_VERSION = '1769024661|5058216174';
/** @type {string} */
const CACHE_PREFIX = 'Rogue-like-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'SciFiSurvivors.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["SciFiSurvivors.html","SciFiSurvivors.js","SciFiSurvivors.offline.html","SciFiSurvivors.icon.png","SciFiSurvivors.apple-touch-icon.png","SciFiSurvivors.audio.worklet.js","SciFiSurvivors.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["SciFiSurvivors.wasm","SciFiSurvivors.pck"];
