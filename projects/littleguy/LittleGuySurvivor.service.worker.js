...
/** @type {string} */
const CACHE_VERSION = '1732646731|2663243451';
/** @type {string} */
const CACHE_PREFIX = 'Your First 2D Ga-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'LittleGuySurvivor.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["LittleGuySurvivor.html","LittleGuySurvivor.js","LittleGuySurvivor.offline.html","LittleGuySurvivor.icon.png","LittleGuySurvivor.apple-touch-icon.png","LittleGuySurvivor.worker.js","LittleGuySurvivor.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["LittleGuySurvivor.wasm","LittleGuySurvivor.pck"];
