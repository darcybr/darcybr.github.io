...
/** @type {string} */
const CACHE_VERSION = '1734111326|2504428265';
/** @type {string} */
const CACHE_PREFIX = 'Survivors-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Survivors.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Survivors.html","Survivors.js","Survivors.offline.html","Survivors.icon.png","Survivors.apple-touch-icon.png","Survivors.worker.js","Survivors.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Survivors.wasm","Survivors.pck"];
