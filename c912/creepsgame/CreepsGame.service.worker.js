...
/** @type {string} */
const CACHE_VERSION = '1733770191|267872075376';
/** @type {string} */
const CACHE_PREFIX = 'BulldogDodge-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'CreepsGame.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["CreepsGame.html","CreepsGame.js","CreepsGame.offline.html","CreepsGame.icon.png","CreepsGame.apple-touch-icon.png","CreepsGame.worker.js","CreepsGame.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["CreepsGame.wasm","CreepsGame.pck"];
