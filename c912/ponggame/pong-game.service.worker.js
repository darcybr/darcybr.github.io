...
/** @type {string} */
const CACHE_VERSION = '1732318109|70143991';
/** @type {string} */
const CACHE_PREFIX = 'Pong Game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'pong-game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["pong-game.html","pong-game.js","pong-game.offline.html","pong-game.icon.png","pong-game.apple-touch-icon.png","pong-game.worker.js","pong-game.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["pong-game.wasm","pong-game.pck"];
